                ...
                <div className="bg-white rounded-3xl border border-gray-100 overflow-scroll w-full shadow-sm">
                    <table className="w-3xl md:w-full overflow-scroll text-left">
                        ...
                        {courses.map((course) => (
                            ...
                            <td className="p-5">
                                <Link href={`/dashboard/admin/${params.uuid}/${course.id}/edit-course`} className="font-bold hover:text-blue-500">{course.title}</Link>
                            ...
                            <td className="p-5 space-x-2">
                                <button  className="text-blue-600 font-bold text-sm hover:underline">Edit Course</button>
                                <button 
